...
if [ -f /.dockerenv ]; then
  declare -a files=(".bash_profile" ".bash_prompt" ".bashrc" ".inputrc" ".vimrc" ".zshenv" ".zshrc" ".shell_variables")
else
  declare -a files=(".bash_profile" ".bash_prompt" ".bashrc" ".gitconfig" ".inputrc" ".vimrc" ".zshenv" ".zshrc" ".shell_variables")
